...
from kettled.constants.enums import COMMAND_MESSAGE, COMMANDS, EVENT_PARAMETERS, UPDATE_EVENT_PARAMETERS, ERROR_MESSAGES
        ...
        with open(PIPE_FILE, 'r') as pipe:
            ...
            if daemon.scheduler is not None:
                if parsed_command[COMMAND_MESSAGE.COMMAND.value] == COMMANDS.LIST.value:
                    ...
                    daemon.scheduler.remove(event_name=parsed_command[COMMAND_MESSAGE.DATA.value][EVENT_PARAMETERS.EVENT_NAME.value])
