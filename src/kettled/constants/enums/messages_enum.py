...
class MESSAGES_ENUM(EnumSuperclass):
    # USAGE = f"{ICONS_ENUM.KETTLE.value} available commands: {DAEMON_COMMANDS_ENUM.START.value} | {DAEMON_COMMANDS_ENUM.STOP.value} | {DAEMON_COMMANDS_ENUM.RESTART.value} | {DAEMON_COMMANDS_ENUM.STATUS.value}\n"
    USAGE = f"{ICONS_ENUM.KETTLE.value} available commands:\n"
