...
def test_update_event_all_fields_success_case():
    ...
    try:
        ...
        assert True
    assert test_instance.in_memory_storage[after_tomorrows_timestamp][seeds.UPDATED_EVENT_NAME][EVENT_PARAMETERS_ENUM.CALLBACK.value]()() == seeds.UPDATED_EVENT_CALLBACK_VALUE
...
def test_update_event_datetime_success_case():
    ...
    test_instance.update(
        ...
        new_date_time=str(after_tomorrows_datetime),
        new_callback=None)
    assert test_instance.in_memory_storage[after_tomorrows_timestamp][seeds.EVENT_NAME][EVENT_PARAMETERS_ENUM.CALLBACK.value]()()() == seeds.EVENT_CALLBACK_VALUE
...
def test_update_event_callback_success_case():
    ...
    test_instance.update(
        ...
        new_date_time=None,
        new_callback=seeds.updated_callback)
    assert test_instance.in_memory_storage[tomorrows_timestamp][seeds.EVENT_NAME][EVENT_PARAMETERS_ENUM.CALLBACK.value]()() == seeds.UPDATED_EVENT_CALLBACK_VALUE
    assert test_instance.index[seeds.EVENT_NAME] == tomorrows_timestamp
